  ...
  return (
    <div className="min-h-screen bg-white text-[#37352F] pb-24 font-sans selection:bg-blue-100 selection:text-blue-900">
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
        ...
        {/* --- Notion Style Header --- */}
        <header className="pt-20 pb-8 border-b border-gray-50 flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
        ...
        {/* --- Notion Style Logs --- */}
        <section className="mt-6 border-t border-gray-50 pt-16">
